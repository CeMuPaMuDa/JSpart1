...
/*По факту, обьект я только создала для соответствия заданию. Тот же результат можно было вывести и без создания обьекта. Данный код может понадобится только в случае, если нам надо будет в дальнейшем создать массив таких обьектов и вывести результат для каждого обьекта массива*/